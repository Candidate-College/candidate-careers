...
const CandidateForm: React.FC = () => {
  const { formData, currentStep, totalSteps, setFormData, nextStep } = useFormStore();
  ...
  const validateForm = () => {
    ...
    if (!formData.instagramAccount) newErrors.instagramAccount = 'Instagram Account is required';
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 mb-4 md:mb-6 sm:grid-cols-1">
              <div>
                ...
                <input type="email" id="email" name="email" placeholder="Enter your email address" value={formData.email} onChange={handleChange} className="w-full px-2 py-2 md:px-3 md:py-3 text-sm text-slate-700 bg-slate-50 border border-slate-300 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 placeholder-slate-400" required />
              ...
              <div>
                ...
                <input type="text" id="name" name="name" placeholder="Enter your name" value={formData.name} onChange={handleChange} className="w-full px-2 py-2 md:px-3 md:py-3 text-sm text-slate-700 bg-slate-50 border border-slate-300 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 placeholder-slate-400" required />
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 mb-4 md:mb-6">
              <div>
                ...
                <input type="text" id="domicile" name="domicile" placeholder="Enter your city & province" value={formData.domicile} onChange={handleChange} className="w-full px-2 py-2 md:px-3 md:py-3 text-sm text-slate-700 bg-slate-50 border border-slate-300 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 placeholder-slate-400" required />
              ...
              <div>
                ...
                <input type="text" id="university" name="university" placeholder="Enter your university/school name" value={formData.university} onChange={handleChange} className="w-full px-2 py-2 md:px-3 md:py-3 text-sm text-slate-700 bg-slate-50 border border-slate-300 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 placeholder-slate-400" required />
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 mb-4 md:mb-6">
              ...
              <div>
                ...
                <input type="number" id="semester" name="semester" placeholder="Enter your semester (Ex: 4)" value={formData.semester} onChange={handleChange} className="w-full px-2 py-2 md:px-3 md:py-3 text-sm text-slate-700 bg-slate-50 border border-slate-300 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 placeholder-slate-400" required />
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 mb-6 md:mb-8">
              <div>
                ...
                <div className="flex items-center">
                  ...
                  <input type="tel" id="whatsappNumber" name="whatsappNumber" placeholder="Enter your WhatsApp number" value={formData.whatsappNumber} onChange={handleChange} className="w-full px-2 py-2 md:px-3 md:py-3 text-sm text-slate-700 bg-slate-50 border border-slate-300 rounded-r-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 placeholder-slate-400" required />
                </div>
              ...
              <div>
                ...
                <input type="text" id="instagramAccount" name="instagramAccount" placeholder="Enter your Instagram username" value={formData.instagramAccount} onChange={handleChange} className="w-full px-2 py-2 md:px-3 md:py-3 text-sm text-slate-700 bg-slate-50 border border-slate-300 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 placeholder-slate-400" required />
