      ...
      <div className="container mx-auto px-4 py-2 md:py-16 max-w-screen-lg xxsm:mt-32">
        <div className="bg-white p-4 md:p-8 rounded-xl shadow-xl min-h-[800px] max-w-[900px] mx-auto px-2 sm:px-4">
          ...
          <form onSubmit={handleSubmit}>
            <h3 className="text-lg md:text-xl font-bold mb-4 md:mb-6 text-slate-700 sm:text-base">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 mb-4 md:mb-6">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1 md:mt-2">
                  If you are a student or fresh graduate, type &quot; - &quot;
                </p>
              </div>
            </div>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 mb-6 md:mb-8">
              <div>
                ...
                <div className="flex items-center">
                  <span className="bg-slate-100 px-3 py-2 md:py-3 text-sm text-slate-600 border border-r-0 border-slate-300 rounded-l-lg">
                    +62
                  </span>
                  <input
                    type="tel"
                    ...
                    onChange={handleChange}
                    className="w-full px-2 py-2 md:px-3 md:py-3 text-sm text-slate-700 bg-slate-50 border border-slate-300 rounded-r-lg focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 placeholder-slate-400"
                    required
                  />
                </div>
