    ...
    <>
      ...
      <div className="container mx-auto px-4 py-2 md:py-16 max-w-screen-lg xxsm:mt-32">
        <div className="bg-white p-4 md:p-8 rounded-xl shadow-xl min-h-[800px] max-w-[900px] mx-auto">
          ...
          <h2 className="text-xl md:text-2xl font-bold mb-2 md:mb-4 text-center text-slate-700">Front-End Developer</h2>
          ...
          <form onSubmit={handleSubmit}>
            <h3 className="text-lg md:text-xl font-bold mb-4 xxsm:mt-16 md:mb-6 text-slate-700">Upload requirements</h3>
