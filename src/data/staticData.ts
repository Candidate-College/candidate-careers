...
export const contactUsSectionOnLanding = {
  ...
  description:
    "Contact and visit our social media if you want to collaborate in any form with Candidate College.",
};
...
export const sendUsMessageSectionOnLanding = {
  ...
  title: "Interested To Cooperate With Us?",
  description:
    "Send messages, suggestions, and criticisms to us and wait for a reply in the email listed, thank you!",
};

export const aboutCandidateCollege =
  "Candidate College is an education platform organization that works to facilitate students in Indonesia at home and abroad to achieve a quality education system";

export const visionCandidateCollege =
  "Vision of Candidate College is to achieve quality equally for all Indonesian students at home and abroad";

export const misionCandidateCollege =
  "Mission of Candidate College is to achieve quality equally for all Indonesian students at home and abroad";
